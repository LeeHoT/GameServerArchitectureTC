package com.test.qingcity.util;

import java.util.ArrayList;
import java.util.List;

import com.qingcity.constants.PortConstant;
import com.test.qingcity.netty.ClientHandler;
import com.test.qingcity.netty.NettyMsgDecoder;
import com.test.qingcity.netty.NettyMsgEncoder;
...
public class BaseConnection {
	...
	public void connectServer(int clientNum) {
		...
		System.out.println("--------------共有" + clientNum + "个客户端同时连接服务器");
	}
